...
pub const KEYS: &[Key] = &[
    ...
    Key {
        r#mod: MODKEY,
        keysym: XK_b,
        func: Some(Arg::togglebar),
        arg: crate::Arg::I(0),
    },
    Key {
        r#mod: MODKEY,
        keysym: XK_i,
        func: Some(Arg::incnmaster),
        arg: crate::Arg::I(1),
    },
    Key {
        r#mod: MODKEY,
    ...
    Key {
        ...
        keysym: XK_c,
        func: Some(Arg::killclient),
        arg: crate::Arg::I(1),
    },
    Key {
        r#mod: MODKEY,
        keysym: XK_t,
        func: Some(Arg::setlayout),
        arg: crate::Arg::Layout(Some(&LAYOUTS[0])),
    },
    Key {
        r#mod: MODKEY,
        keysym: XK_f,
        func: Some(Arg::togglefullscreen),
        arg: crate::Arg::I(0),
    },
    Key {
        r#mod: MODKEY,
    ...
    Key {
        r#mod: MODKEY,
        keysym: XK_s,
        func: Some(Arg::togglesticky),
        arg: crate::Arg::I(0),
    },
    Key {
        r#mod: MODKEY,
        keysym: XK_j,
        func: Some(Arg::focusstack),
    ...
    Key {
        r#mod: MODKEY,
        keysym: XK_g,
        func: Some(Arg::shiftviewclients),
        arg: crate::Arg::I(1),
    },
    Key {
        r#mod: MODKEY | SHIFT_MASK,
        keysym: XK_g,
        func: Some(Arg::shifttagclients),
        arg: crate::Arg::I(1),
    },
    Key {
        r#mod: MODKEY,
